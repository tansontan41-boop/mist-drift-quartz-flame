...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DFstOc3P.js
var router_DFstOc3P_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CAJgDLVk.css";
var APP_NAME = "银居计划";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "上海银发商店模式落地商业计划：深圳 vs 老家费用明细与测算。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-r8Qyki_u.mjs");
...
//#endregion
export { getRouter, router_DFstOc3P_exports as t };
